  ...
  "inline-flex items-center gap-1.5 rounded-full border px-2.5 py-0.5 font-mono text-[11px] font-medium tabular-nums transition-colors",
  {
    variants: {
      variant: {
        ...
        critical:
          "border-rose-500/25 bg-rose-500/10 text-rose-700 dark:border-rose-500/30 dark:text-rose-300",
        warning:
        ...
        success:
          "border-emerald-500/25 bg-emerald-500/10 text-emerald-700 dark:border-emerald-500/30 dark:text-emerald-300",
