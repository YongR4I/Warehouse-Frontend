...
const dummyData = [
  {
    ...
    tanggal: "18 Jul 2026",
    totalItem: "2 SKU (150 Pcs)",
    dibuatOleh: "Budi Santoso",
    status: "disetujui",
    dokumen: "invoice-guardian-14.pdf",
  },
  {
    ...
    tanggal: "23 Jul 2026",
    totalItem: "1 SKU (30 Pcs)",
    dibuatOleh: "Rina Wijaya",
    status: "disetujui",
    dokumen: "invoice-watsons-23.pdf",
  },
  {
    noReferensi: "BK-20260719-017",
    gudangTujuan: "Gudang Utama (Pusat)",
    customer: "CV Beauty Cosmindo",
    tanggal: "19 Jul 2026",
    totalItem: "2 SKU (80 Pcs)",
    dibuatOleh: "Budi Santoso",
    status: "menunggu_approval",
    dokumen: "PO-beauty-17.pdf",
  },
  {
    noReferensi: "BK-20260720-019",
    gudangTujuan: "Gudang Utama (Pusat)",
    customer: "Toko Parfum Sejahtera",
    tanggal: "20 Jul 2026",
    totalItem: "1 SKU (10 Pcs)",
    dibuatOleh: "Budi Santoso",
    status: "draft",
    dokumen: "-",
  },
  {
    noReferensi: "BK-20260722-021",
    gudangTujuan: "Gudang Utama (Pusat)",
    customer: "CV Beauty Cosmindo",
    tanggal: "22 Jul 2026",
    totalItem: "3 SKU (140 Pcs)",
    dibuatOleh: "Ahmad Dahlan",
    status: "ditolak",
    dokumen: "PO-beauty-ret.pdf",
  },
] as const
    ...
    <>
      ...
      <div className="wrapper mt-[50px]">
        <div className="flex items-center gap-2">
          <InputSearch placeholder="Cari no. referensi atau customer..." className="flex-1" />
          <Opsion
            options={[
