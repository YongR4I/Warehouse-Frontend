...
const dummyData = [
  {
    ...
    asal: "Gudang Utama (Pusat)",
    tujuan: "Gudang Timur",
    barang: "Mikonos Monaco 50ml",
    qty: 50,
    tanggal: "20 Jul 2026",
    dibuatOleh: "Rina Wijaya",
    status: "disetujui",
    dokumen: "sj-mutasi-31.pdf",
  },
  {
    noReferensi: "MT-20260721-033",
    asal: "Gudang Selatan",
    tujuan: "Gudang Utama (Pusat)",
    barang: "Kahf Face Wash 100ml",
    qty: 120,
    tanggal: "21 Jul 2026",
    dibuatOleh: "Ahmad Dahlan",
    status: "menunggu_approval",
    dokumen: "sj-mutasi-33.pdf",
  },
  {
    noReferensi: "MT-20260722-035",
    asal: "Gudang Utama (Pusat)",
    tujuan: "Gudang Selatan",
    barang: "Somethinc Niacinamide 20ml",
    qty: 15,
    tanggal: "22 Jul 2026",
  ...
  {
    noReferensi: "MT-20260723-037",
    asal: "Gudang Timur",
    tujuan: "Gudang Utama (Pusat)",
    barang: "Sensi Mask 3-Ply Earloop",
    qty: 30,
    tanggal: "23 Jul 2026",
    dibuatOleh: "Rina Wijaya",
    status: "ditolak",
    dokumen: "sj-mutasi-37.pdf",
  },
  {
    noReferensi: "MT-20260724-039",
    asal: "Gudang Utama (Pusat)",
    tujuan: "Gudang Timur",
    barang: "Mikonos Aphrodite 100ml",
    qty: 80,
    tanggal: "24 Jul 2026",
    dibuatOleh: "Rina Wijaya",
    status: "disetujui",
    dokumen: "sj-mutasi-39.pdf",
  },
  {
    noReferensi: "MT-20260724-041",
    asal: "Gudang Selatan",
    tujuan: "Gudang Timur",
    barang: "Kahf Face Wash 100ml",
    qty: 10,
